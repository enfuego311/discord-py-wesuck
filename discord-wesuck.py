...
@bot.command(pass_context=True, help="Sends a query to Tenor to get the top match based on your search terms.", brief="Tenor top gif.")
...
@bot.command(pass_context=True, help="Sends a query to Tenor to get a random match based on your search terms.", brief="Tenor random gif.")
...
# weather command
@bot.command(pass_context=True, help="This will query the google maps api to get the latitude and longitude. Using that it will query the OpenWeather API for local conditions.", brief="Weather for the location specified.")
